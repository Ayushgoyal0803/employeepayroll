...
public class JwtUtility {
    ...
    private static final String SECRET_KEY = "QWERTYUIOP0ASDFJKLZXCVBNM74152963";

    public String generateToken(String email){
        return Jwts.builder()
                .setSubject(email)
                .setIssuedAt(new Date())
                .setExpiration(new Date(System.currentTimeMillis() + 5 *60 * 1000))  // expire after 5 minute
